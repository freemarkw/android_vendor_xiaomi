...
LOCAL_SRC_FILES := proprietary/vendor/etc/qdcm_calib_data_otm1901a_1080p_video_DJ_otp.xml
LOCAL_MODULE_TAGS := optional
...
LOCAL_MODULE_OWNER := cmdc
LOCAL_SRC_FILES := proprietary/vendor/etc/qdcm_calib_data_r63350_1080p_video_Tianma.xml
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_SUFFIX := .xml
include $(BUILD_PREBUILT)
